...
def generate_template(width, height, name, pins="pins.cfg", src="src/heichips26_template.v"):
	...
	flow_cfg = {
		...
		"DESIGN_NAME"    : "heichips26_template",
	...
	m = list(sorted(glob.glob(os.path.join('runs', '*', 'final', 'def', 'heichips26_template.def'))))[-1]
