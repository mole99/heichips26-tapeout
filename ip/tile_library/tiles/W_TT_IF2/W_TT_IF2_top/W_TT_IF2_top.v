...
`endif
 ...
 //S
        ...
        input  [7:0] bot2top_UIO_OUT,        //Port(Name=bot2top_UIO_OUT,IO=INPUT,XOffset=0,YOffset=-1,WireCount=8,Side=S)
        input  [7:0] bot2top_UIO_OE,        //Port(Name=bot2top_UIO_OE,IO=INPUT,XOffset=0,YOffset=-1,WireCount=8,Side=S)
        output  [7:0] top2bot_UIO_IN,        //Port(Name=top2bot_UIO_IN,IO=OUTPUT,XOffset=0,YOffset=1,WireCount=8,Side=S)
