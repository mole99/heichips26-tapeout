...
`endif
 ...
 //S
        ...
        input  [15:0] bot2top_DOUT,        //Port(Name=bot2top_DOUT,IO=INPUT,XOffset=0,YOffset=-1,WireCount=16,Side=S)
        output  [15:0] top2bot_DIN,        //Port(Name=top2bot_DIN,IO=OUTPUT,XOffset=0,YOffset=1,WireCount=16,Side=S)
        output  [15:0] top2bot_BM,        //Port(Name=top2bot_BM,IO=OUTPUT,XOffset=0,YOffset=1,WireCount=16,Side=S)
        output  [4:0] top2bot_ADDR,        //Port(Name=top2bot_ADDR,IO=OUTPUT,XOffset=0,YOffset=1,WireCount=5,Side=S)
